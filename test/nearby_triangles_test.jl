...
nearby_triangles1 = find_nearby_triangles(mesh, bvh_tree, point, √3.0)
nearby_triangles2 = find_nearby_triangles(mesh, bvh_tree, point, √3.0-0.0001)

@test length(nearby_triangles1) == 1
@test length(nearby_triangles2) == 0
